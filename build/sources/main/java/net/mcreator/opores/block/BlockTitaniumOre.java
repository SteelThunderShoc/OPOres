...
public class BlockTitaniumOre extends ElementsOPOres.ModElement {
	@GameRegistry.ObjectHolder("opores:titaniumore")
	public static final Block block = null;
	public BlockTitaniumOre(ElementsOPOres instance) {
		super(instance, 23);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("opores:titaniumore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemTitaniumChunk.block, (int) (4)));
		}
	}
}
